 ...
 * @author sanjose
 */
public class EditorAcom extends DefaultGraphCellEditor {
    public EditorAcom() {}
    ...
    class RealCellEditor extends AbstractCellEditor implements GraphCellEditor {
         ...
         */
        InputAcom editorComponent = new InputAcom(this);
        ...
        public Component getGraphCellEditorComponent(JGraph graph, Object value, boolean isSelected) {
            ...
            if(value instanceof AcomBean) editorComponent.installValue((AcomBean)value);
            else {
                AcomBean wrapper = new AcomBean();
