...
public class EditorGRD extends DefaultGraphCellEditor {
    public EditorGRD() {}
    ...
    class RealCellEditor extends AbstractCellEditor implements GraphCellEditor {
         ...
         */
        InputGRD editorComponent = new InputGRD(this);
        ...
        public Component getGraphCellEditorComponent(JGraph graph, Object value, boolean isSelected) {
            ...
            if(value instanceof GRDBean) editorComponent.installValue((GRDBean)value);
            else {
                GRDBean wrapper = new GRDBean();
