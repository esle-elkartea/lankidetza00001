...
public class EditorCT extends DefaultGraphCellEditor {
    public EditorCT() {}
    ...
    class RealCellEditor extends AbstractCellEditor implements GraphCellEditor {
         ...
         */
        InputCT editorComponent = new InputCT(this);
        ...
        public Component getGraphCellEditorComponent(JGraph graph, Object value, boolean isSelected) {
            ...
            if(value instanceof CTBean) editorComponent.installValue((CTBean)value);
            else {
                CTBean wrapper = new CTBean();
