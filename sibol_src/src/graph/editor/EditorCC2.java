 ...
 * @author sanjose
 */
public class EditorCC2 extends DefaultGraphCellEditor {
    public EditorCC2() {}
    ...
    class RealCellEditor extends AbstractCellEditor implements GraphCellEditor {
         ...
         */
        InputCC2 editorComponent = new InputCC2(this);
        ...
        public Component getGraphCellEditorComponent(JGraph graph, Object value, boolean isSelected) {
            ...
            if(value instanceof CCBean) editorComponent.installValue((CCBean)value);
            else {
                CCBean wrapper = new CCBean();
