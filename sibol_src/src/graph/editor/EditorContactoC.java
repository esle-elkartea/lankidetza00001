...
import graph.input.InputContactoC;
...
public class EditorContactoC extends DefaultGraphCellEditor {
    public EditorContactoC() {}
    ...
    class RealCellEditor extends AbstractCellEditor implements GraphCellEditor {
         ...
         */
        InputContactoC editorComponent = new InputContactoC(this);
