...
public class EditorM1 extends DefaultGraphCellEditor {
    public EditorM1() {}
    ...
    class RealCellEditor extends AbstractCellEditor implements GraphCellEditor {
         ...
         */
        InputM1 editorComponent = new InputM1(this);
        ...
        public Component getGraphCellEditorComponent(JGraph graph, Object value, boolean isSelected) {
            ...
            if(value instanceof M1Bean) editorComponent.installValue((M1Bean)value);
            else {
                M1Bean wrapper = new M1Bean();
