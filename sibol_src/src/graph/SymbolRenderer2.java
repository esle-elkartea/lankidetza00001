...
public class SymbolRenderer2 extends VertexRenderer {
    private VertexView symbolView = null;
    private String svgResource = null;

    public SymbolRenderer2(VertexView v, String svg) {
        this.symbolView = v;
    ...
    public void paint(Graphics g) {
        ...
        if(selected) {
            ...
            g2.setStroke(dashed);
            g.drawRect(0, 0, getWidth() - borderWidth, getHeight() - Constantes.CAJETIN_ALTO - borderWidth);
            g.setColor(color0);
        ...
        int xTexto = Constantes.LABEL_POSX2;
        int yTexto = (int)d.getHeight() - Constantes.CAJETIN_ALTO + Constantes.LABEL_POSY2;
        
        int anchuraCuadro = (int)d.getWidth() - 12;
        int alturaCuadro = Constantes.CAJETIN_ALTO;
        int alturaFila = alturaCuadro / Constantes.NUMFILAS_SALIDA;
        int xCuadro = xTexto - 4;
